...
window.onload = function () {
	...
	if (window.innerWidth<767.990 && fullscreenButton) {
		fullscreenButton.classList.add('_icon-arrow-link');
	}
...
if (window.innerWidth>991.98) {
	...
	function _goto(target_block, speed, offset = 60) {
		let header = '';
		//OffsetHeader
		//if (window.innerWidth < 992) {
		//	header = 'header';
	...
	function _goto(target_block, speed, offset = 90) {
		let header = '';
		//OffsetHeader
		//if (window.innerWidth < 992) {
		//	header = 'header';
...
function mapInit(n = 1) {
	...
	var locations = [
		[new google.maps.LatLng(40.7159774176387, -73.99912322854368)],
		[new google.maps.LatLng(40.7159774176387, -73.99912322854368)],
		[new google.maps.LatLng(40.7159774176387, -73.99912322854368)],
		[new google.maps.LatLng(40.7159774176387, -73.99912322854368)],
	]
...
function map(n) {
	...
	function init() {
		...
		var myMap = new ymaps.Map(".adress__map", {
			...
			controls: [],
			center: [40.7159774176387, -73.99912322854368],
