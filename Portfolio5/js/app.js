...
if (document.querySelector('.slider-series__body')) {
	let sliderSeries = new Swiper('.slider-series__body', {
		/*
		effect: 'fade',
		autoplay: {
			delay: 3000,
...
if (document.querySelector('.slider-movies__body')) {
	let sliderSeries = new Swiper('.slider-movies__body', {
		/*
		effect: 'fade',
		autoplay: {
			delay: 3000,
		...
		*/
		...
		// Arrows
		navigation: {
			nextEl: '.slider-movies__arrow.slider-arrow_next',
			prevEl: '.slider-movies__arrow.slider-arrow_prev',
		},
		breakpoints: {
			320: {
				slidesPerView: 2,
...
if (document.querySelector('.slider-channels__body')) {
	let sliderSeries = new Swiper('.slider-channels__body', {
		/*
		effect: 'fade',
		autoplay: {
			delay: 3000,
		...
		*/
		...
		// Arrows
		navigation: {
			nextEl: '.slider-channels__arrow.slider-arrow_next',
			prevEl: '.slider-channels__arrow.slider-arrow_prev',
		},
		breakpoints: {
			320: {
				slidesPerView: 1,
...
if (document.querySelector('.slider-actors__body')) {
	let sliderSeries = new Swiper('.slider-actors__body', {
		/*
		effect: 'fade',
		autoplay: {
			delay: 3000,
		...
		*/
		...
		// Arrows
		navigation: {
			nextEl: '.slider-actors__arrow.slider-arrow_next',
			prevEl: '.slider-actors__arrow.slider-arrow_prev',
		},
		breakpoints: {
			320: {
				slidesPerView: 1,
