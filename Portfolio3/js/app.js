...
function mapInit(n = 1) {
	...
	var locations = [
		[new google.maps.LatLng(49.824192966805136, 73.0855933459047)],
		[new google.maps.LatLng(49.824192966805136, 73.0855933459047)],
		[new google.maps.LatLng(49.824192966805136, 73.0855933459047)],
		[new google.maps.LatLng(49.824192966805136, 73.0855933459047)],
	]
...
function map(n) {
	...
	function init() {
		// Создание карты.
		var myMap = new ymaps.Map(".contacts__map-body", {
			// Координаты центра карты.
			// Порядок по умолчанию: «широта, долгота».
			// Чтобы не определять координаты центра карты вручную,
			// воспользуйтесь инструментом Определение координат.
			controls: [],
			center: [49.824192966805136, 73.0855933459047],
			// Уровень масштабирования. Допустимые значения:
			// от 0 (весь мир) до 19.
			zoom: 19
		});

		let myPlacemark = new ymaps.Placemark([49.824192966805136, 73.0855933459047], {
		},{
			// Опции.
...
let sliderMain = new Swiper('.slider-main__body', {
	/*
	//effect: 'fade',
	autoplay: {
		delay: 3000,
...
let sliderGallery = new Swiper('.slider-gallery__body', {
	//effect: 'fade',
	autoplay: {
		delay: 5000,
		disableOnInteraction: false,
...
let sliderProjects = new Swiper('.slider-projects__body', {
	/*
	//effect: 'fade',
	autoplay: {
		delay: 5000,
...
let sliderCertificate = new Swiper('.slider-certificate__body', {
	/*
	//effect: 'fade',
	autoplay: {
		delay: 3000,
	...
	*/
	...
	pagination: {
		type: "fraction",
		el: '.slider-certificate__pagination',
		clickable: false,
	},
	// Arrows
	navigation: {
